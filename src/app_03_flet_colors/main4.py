...
def main(page: ft.Page):
    ...
    for name in palettes:
        color_val = getattr(ft.Colors, name, None)
        if color_val:
            grid_base_colors.controls.append(
                ft.Container(
                    content=ft.Text(name, color=ft.Colors.WHITE, weight=ft.FontWeight.BOLD, size=11),
                    bgcolor=color_val,
    ...
    page.add(
        ...
        # --- NUEVA SECCIÓN AL INICIO ARRIBA ---
        ft.Text("Carta de Colores Base (Material)", size=16, weight=ft.FontWeight.BOLD),
        grid_base_colors,
        # --------------------------------------
